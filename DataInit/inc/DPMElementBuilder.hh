...
#ifndef DPMElementBuilder_h
#define DPMElementBuilder_h 1

//---------------------------------------------------------------------------
//
// ClassName:   DPMElementBuilder
//
...
class DPMElementBuilder
{
public:

  explicit DPMElementBuilder(G4int vb);
  ~DPMElementBuilder();
...
inline G4double DPMElementBuilder::GetAtomicMassAmu(G4int Z) const
{
...
inline G4double DPMElementBuilder::GetIsotopeMass(G4int Z, G4int N) const
{
  G4double mass = 0.0;
...
inline G4double DPMElementBuilder::GetAtomicMass(G4int Z, G4int N) const
{
  G4double mass = 0.0;
  if(Z > 0 && Z < maxNumElements) {
    G4int i = N - nFirstIsotope[Z];
...
inline 
G4double DPMElementBuilder::GetTotalElectronBindingEnergy(G4int Z) const
{
...
inline 
G4double DPMElementBuilder::GetIsotopeAbundance(G4int Z, G4int N) const
{
  G4double x = 0.0;
  if(Z > 0 && Z < maxNumElements) {
    G4int i = N - nFirstIsotope[Z];
...
inline G4int DPMElementBuilder::GetNistFirstIsotopeN(G4int Z) const
{
...
inline G4int DPMElementBuilder::GetNumberOfNistIsotopes(G4int Z) const
{
...
inline 
const std::vector<G4String>& DPMElementBuilder::GetElementNames() const
{
  return elmNames;
}
...
inline G4int DPMElementBuilder::GetMaxNumElements() const
{
...
inline void DPMElementBuilder::SetVerbose(G4int val) 
{
  verbose = val;
}
...
inline G4Element* DPMElementBuilder::FindElement(G4int Z) const
{
