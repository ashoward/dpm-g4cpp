...
#ifndef DPMMaterialBuilder_h
#define DPMMaterialBuilder_h 1

//---------------------------------------------------------------------------
//
// ClassName:   DPMMaterialBuilder
//
...
class DPMMaterialBuilder
{
public:

  DPMMaterialBuilder(DPMElementBuilder*, G4int verb=0);
  ...
  // verbosity level defined by DPMManager
  //
...
inline const std::vector<G4String>& 
       DPMMaterialBuilder::GetMaterialNames() const
{
  return names;
}

inline G4double 
DPMMaterialBuilder::GetMeanIonisationEnergy(G4int index) const
{
  return (index >= 0 && index < nMaterials) ? ionPotentials[index] : 10.0*index; 
}

inline G4double 
DPMMaterialBuilder::GetNominalDensity(G4int index) const
{
  return (index >= 0 && index < nMaterials) ? densities[index] : 0.0;
}

inline G4Material* 
DPMMaterialBuilder::FindMaterial(const G4String& name) const
{
...
inline G4Material* 
DPMMaterialBuilder::FindSimpleMaterial(G4int Z) const
{
